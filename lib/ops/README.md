...
gpu_ptd "" "server01" "/path/config" "01:00.0" "02:00.0"
```
...
_gpu_get_config_pci_ids "hostname" "server01"
...
_gpu_get_target_gpus() {
    ...
    local param5="$5"        # pci0_id OR pci1_id
    local param6="$6"        # pci1_id (only for "hostname" mode)
...
gpu_ptd "" "testhost" "/test/config" "01:00.0" "02:00.0"
