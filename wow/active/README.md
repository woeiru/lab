...
- Every non-README file in `wow/active/` must use `yyyymmdd-hhmm_filename`.
...
- Plan moved to `wow/completed/*_spec-hierarchy-and-enforcement-plan.md`.
- Next planned action: strict/report default wiring, then rerun baselines.

## How to use this folder

1. **Planned work**: move a file from `wow/queue/` to this directory when
