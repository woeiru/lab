...
- Links: wow/completed/20260307-2345_multi_ops-hotspot-wave-2-release-program-plan/20260307-2048_ops-hotspot-wave-2-release-program-plan.md, val/run_all_tests.sh, doc/ref/functions.md, doc/ref/test-coverage.md
...
1. Closed this WS-03 item from `wow/active/` to
   `wow/completed/20260307-2345_multi_ops-hotspot-wave-2-release-ws-03-plan/`.
