...
`wow/active` was renamed with numeric prefixes (old names deleted, new names added), and review coverage became hard to track. This file reconstructs what exists, what was likely missing, and what is still open.

## Canonical active file set

- `wow/active/0-ana-module-expansion-plan.md`
- `wow/active/1-ana-implementation-review.md`
- `wow/active/2-ana-module-expansion-review.md`
- `wow/active/2-ana-dep-strict-review.md`
- `wow/active/2-ana-tst-strict-review.md`
- `wow/active/2-ana-err-strict-review.md`
- `wow/active/2-ana-scp-strict-review.md`
- `wow/active/2-ana-rdp-strict-review.md`
- `wow/active/3-ana-module-expansion-reconstruction-status.md`

## Reconstructed missing review docs

- Added `wow/active/2-ana-tst-strict-review.md`
- Added `wow/active/2-ana-err-strict-review.md`
