...
- Links: cfg/core/lzy, bin/orc, lib/.spec, lib/ops/.spec, lib/gen/.spec, AGENTS.md, doc/arc/03-operational-modules.md, doc/arc/02-core-and-gen.md, doc/man/05-writing-modules.md, val/core/initialization/orc_test.sh, wow/active/20260304-0028_antigravity-account-reload-persistence-plan.md
...
`wow/active/20260304-0028_antigravity-account-reload-persistence-plan.md`.
...
1. Run `bash wow/check-workflow.sh` after each workflow doc move/edit.
...
- Any future lazy-map compliance regression should be captured as a new `wow/inbox/*-issue.md` item with failing test evidence.
