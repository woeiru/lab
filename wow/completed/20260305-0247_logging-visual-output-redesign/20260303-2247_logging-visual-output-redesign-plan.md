...
- Links: lib/core/lo1, lib/core/err, lib/core/tme, lib/core/col, lib/gen/aux, bin/ini, cfg/core/ric, doc/arc/07-logging-and-error-handling.md, wow/inbox/20260303-0336_logging-system-renewal-plan.md, wow/inbox/20260305-0235_dic-debug-verbosity-coupling-followup-plan.md, wow/completed/20260304-2356_logging-performance-renewal/20260303-2245_logging-performance-renewal-plan.md, wow/completed/20260305-0235_logging-architectural-restructure/20260303-2246_logging-architectural-restructure-plan.md, wow/completed/20260305-0000_bootstrap-visual-output-redesign-plan/20260303-0220_bootstrap-visual-output-redesign-plan.md
...
(`wow/completed/20260305-0000_bootstrap-visual-output-redesign-plan/20260303-0220_bootstrap-visual-output-redesign-plan.md`)
...
`wow/completed/20260303-0220_bootstrap-visual-output-redesign-plan`):
...
3. [done 2026-03-05] Executed closeout move for this item to
   `wow/completed/20260305-0235_logging-visual-output-redesign/`.
...
3. `bash wow/check-workflow.sh` passes for updated workflow metadata.
