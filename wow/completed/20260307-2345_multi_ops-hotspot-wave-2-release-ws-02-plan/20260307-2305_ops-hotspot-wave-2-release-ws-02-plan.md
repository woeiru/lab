...
- Links: wow/completed/20260307-2345_multi_ops-hotspot-wave-2-release-program-plan/20260307-2048_ops-hotspot-wave-2-release-program-plan.md, lib/ops/dev, val/lib/ops/dev_test.sh, doc/ref/module-dependencies.md
...
1. Closed this WS-02 item from `wow/active/` to
   `wow/completed/20260307-2345_multi_ops-hotspot-wave-2-release-ws-02-plan/`.
