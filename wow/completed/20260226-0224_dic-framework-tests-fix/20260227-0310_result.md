...
## Discoveries
- The tracking doc `wow/active/validation-suite-failures-followup.md` was read and confirmed still-current failures:
...
- `wow/active/validation-suite-failures-followup.md` (Updated)
