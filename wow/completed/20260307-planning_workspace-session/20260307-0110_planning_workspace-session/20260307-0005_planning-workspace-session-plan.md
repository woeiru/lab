...
- Links: doc/man/08-planning-workspace.md, doc/arc/09-planning-subsystem.md, utl/pla/README.md, utl/pla/map/README.md, utl/pla/map/runs/20260307-0057_present-showcase1/approved-mapping.json, wow/completed/20260307-0128_mapping-apply-phase-tooling/20260307-0104_mapping-apply-phase-tooling-plan.md, wow/active/20260307-0105_export-summary-naming-migration-plan.md, wow/queue/20260307-0106_mapping-rules-v2-client-endpoints-plan.md
...
1. Run `bash wow/check-workflow.sh` after each workflow-file update.
...
6. `bash wow/check-workflow.sh` passes at item handoff.
...
Use `wow/` for workflow state and prioritization, and use `utl/pla/map/` for mapping artifacts and execution contracts.
...
3. Workflow checks passed after state updates:
   - `bash wow/check-workflow.sh` -> `Workflow check passed.`

## What remains

1. Completed `wow/completed/20260307-0128_mapping-apply-phase-tooling/20260307-0104_mapping-apply-phase-tooling-plan.md`.
2. Execute `wow/active/20260307-0105_export-summary-naming-migration-plan.md`.
3. Execute `wow/queue/20260307-0106_mapping-rules-v2-client-endpoints-plan.md`.
