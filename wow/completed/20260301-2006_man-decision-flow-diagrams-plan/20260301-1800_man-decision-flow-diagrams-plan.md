...
- Run workflow integrity check: `bash wow/check-workflow.sh`.
...
- Closed this workflow item and moved it from `wow/active/` to
  `wow/completed/20260301-2006_man-decision-flow-diagrams-plan/` with the original
