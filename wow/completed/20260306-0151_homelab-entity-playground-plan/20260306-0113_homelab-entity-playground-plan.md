...
- Links: cfg/env/, wow/task/inbox-capture, wow/task/RULES.md
...
1. Validate workflow document integrity with `bash wow/check-workflow.sh`.
...
9. `bash wow/check-workflow.sh` -> pass
...
4. Recommended completed archive target:
   `wow/completed/20260306-0143_homelab-entity-playground-plan/`
...
Closed into completed archive: `wow/completed/20260306-0151_homelab-entity-playground-plan/`.
