...
- Links: val/src/dic/dic_basic_test.sh, val/src/dic/dic_integration_test.sh, val/src/dic/dic_phase1_completion_test.sh, src/dic/ops, lib/gen/aux, lib/core/log, cfg/core/ric, wow/completed/20260305-0235_logging-architectural-restructure/20260303-2246_logging-architectural-restructure-plan.md, wow/completed/20260305-0235_logging-visual-output-redesign/20260303-2247_logging-visual-output-redesign-plan.md
...
5. Run `bash wow/check-workflow.sh` before any further state move.
