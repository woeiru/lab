...
- 1. Fix set-to-ops module mismatch (`P0`) - `COMPLETED` (2026-02-18)
- 2. Add bootstrap preflight command `./go doctor` (`P0`) - `COMPLETED` (2026-02-18)
- 3. Resolve `src/aux` drift (`P1`) - `COMPLETED` (2026-02-18)
- 4. Standardize `ini` vs `init` naming (`P1`) - `COMPLETED` (2026-02-18)
- 5. Remove insecure credential defaults (`P1`) - `COMPLETED` (2026-02-18)
- 6. Harden test harness bootstrap (`P2`) - `COMPLETED` (2026-02-18)

## Priority Order

1. Fix set-to-ops module mismatch (`P0`) - `COMPLETED`
...
2. Add bootstrap preflight command `./go doctor` (`P0`) - `COMPLETED`
...
3. Resolve `src/aux` drift (`P1`) - `COMPLETED`
...
4. Standardize `ini` vs `init` naming (`P1`) - `COMPLETED`
...
5. Remove insecure credential defaults (`P1`) - `COMPLETED`
...
6. Harden test harness bootstrap (`P2`) - `COMPLETED`
