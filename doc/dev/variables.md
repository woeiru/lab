...
> **Last Updated**: 2025-06-01 20:33:00  
...
|----------|-------|-------------|---------|---------|---------|
# Using direct variable analysis (bypassing aux-acu)
*Direct Analysis: Variable extraction from config files*
...
| template | "local:vztmpl/debian-1... | 29 | 24 | 4 | 1 |
| storage | "local-zfs" \ | 18 | 15 | 2 | 1 |
| rootfs_size | 32 \ | 5 | 4 | 0 | 1 |
| memory | 8192 \ | 13 | 12 | 0 | 1 |
| swap | 8192 \ | 7 | 6 | 0 | 1 |
| nameserver | "8.8.8.8" \ | 7 | 6 | 0 | 1 |
| searchdomain | "fritz.box" \ | 6 | 5 | 0 | 1 |
| password | '$(cat /tmp/lab_passwo... | 20 | 19 | 0 | 1 |
| cpus | 8 \ | 5 | 4 | 0 | 1 |
| privileged | "yes" \ | 6 | 5 | 0 | 1 |
