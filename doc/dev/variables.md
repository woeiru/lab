...
<!-- Command: aux_ffl ana_acu "" "$CFG_ENV_DIR" "$LIB_OPS_DIR" "$SRC_SET_DIR" -->

*Auto-updated variable usage documentation with real-time analysis*

> **Last Updated**: 2025-06-05 22:56:28  
> **Generated By**: `utl/doc/var`  
> **Total Variables**: 156 variables analyzed across all configuration files
> **Analysis Command**: `aux_ffl ana_acu "" "$CFG_ENV_DIR" "$LIB_OPS_DIR" "$SRC_SET_DIR"`
